    ...
    async function getSign(surl, randsk) {
        ...
        const res1 = await fetch('https://pan.baidu.com/s/1' + surl, {
            ...
            headers: {
                ...
                'Cookie': 'BDUSS=o1VlVTTDZQTE1HSll3Y2F-dXhnWG0tN2tQTU5xMzI4alFMaEg5SFJLV1h5MXBmSUFBQUFBJCQAAAAAAQAAAAEAAADfsYUgsK7l-jc0NzMwNQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAJc-M1-XPjNfSl;' +
                    'STOKEN=11a47bfb4438e974453b3a7650b9c78fcf9f47946ec25761639b2291cb3924a4; BDCLND=' + randsk
                    //  **
            }
        })
